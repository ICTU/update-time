...
class GetLatestVersionTest(LoggingTestCase):
    ...
    def test_publication_date(self, mock_get: Mock):
        ...
        self.assertEqual(
            datetime.fromisoformat(published), get_latest_version("owner/repository", "1.0", NO_BOUND).published
        )
    ...
    def test_version_filter_bounds_candidates(self, mock_get: Mock):
        ...
        mock_get.side_effect = [
            mock_response([release_json("1.1"), release_json("2.0")]),
            mock_response(commits_json()),
        ]
    ...
    def test_no_version_error_when_repo_has_no_releases(self):
        ...
        self.assertEqual(get_latest_version("owner/no releases", "1.0", NO_BOUND).version, "1.0")
...
class GetReleaseTest(LoggingTestCase):
    ...
    def test_monorepo_tag_match(self):
        ...
        self.assertEqual(cast("Release", release).tag_name, "puppeteer-core-v25.0.4")
        self.assertEqual(cast("Release", release).body, "Changelog")
    ...
    def test_v_prefix_tag_match(self):
        ...
        self.assertEqual(cast("Release", release).tag_name, "v1.2.3")
    ...
    def test_bare_version_tag_match(self):
        ...
        self.assertEqual(cast("Release", release).tag_name, "1.2.3")
