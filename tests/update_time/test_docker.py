...
from update_time.docker import get_latest_tag

from .fixtures import DIGEST, DIGEST1, DIGEST2, DIGEST3
from .helpers import CacheClearingTestCase, docker_hub_response, docker_tag, mock_response
...
class GetLatestTagTest(CacheClearingTestCase):
    ...
    def test_new_version_available(self, mock_get: Mock):
        ...
        mock_get.return_value = docker_hub_response(docker_tag("2.1", DIGEST))
    ...
    def test_ignore_tags_without_digest(self, mock_get: Mock):
        ...
        mock_get.return_value = docker_hub_response(docker_tag("2.2", DIGEST), docker_tag("2.3"))
    ...
    def test_multiple_new_versions_available_across_pages(self, mock_get: Mock):
        ...
        page1 = docker_hub_response(docker_tag("2.1", DIGEST1), next_url="https://example.org/next_page")
        page2 = docker_hub_response(docker_tag("2.2", DIGEST2))
    ...
    def test_invalid_new_tag(self, mock_get: Mock):
        ...
        mock_get.return_value = docker_hub_response(docker_tag("invalid", DIGEST))
    ...
    def test_prerelease(self, mock_get: Mock):
        ...
        mock_get.return_value = docker_hub_response(docker_tag("1.4a1", DIGEST))
    ...
    def test_different_suffix(self, mock_get: Mock):
        ...
        mock_get.return_value = docker_hub_response(docker_tag("1.4-windows", DIGEST))
    ...
    def test_within_cooldown(self, mock_get: Mock):
        ...
        mock_get.return_value = docker_hub_response(docker_tag("1.4", DIGEST, tag_last_pushed=recent))
    ...
    def test_outside_cooldown(self, mock_get: Mock):
        ...
        mock_get.return_value = docker_hub_response(docker_tag("1.4", DIGEST, tag_last_pushed=old))
