...
@patch("requests.get")
class UpdateGitLabCIConfigTest(CacheClearingTestCase):
    ...
    def test_no_changes(self, mock_get: Mock, mock_info: Mock, mock_warning: Mock):
        ...
        assert_path_logged(mock_info, config.relative_to())
    ...
    def test_changes(self, mock_get: Mock, mock_info: Mock, mock_warning: Mock):
        ...
        assert_path_logged(mock_info, config.relative_to())
        assert_new_version_logged(mock_warning, "python", "3.14.2")

    def test_pin_unpinned_image(self, mock_get: Mock, mock_info: Mock, mock_warning: Mock):
        ...
        assert_path_logged(mock_info, config.relative_to())
        assert_new_version_logged(mock_warning, "rust", "1.76")

    def test_variable_reference_ignored(self, mock_get: Mock, mock_info: Mock, mock_warning: Mock):
    ...
    def test_missing_config_file(self, mock_get: Mock, mock_info: Mock, mock_warning: Mock):
