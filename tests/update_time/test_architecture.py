...
class LayeringTest(unittest.TestCase):
    ...
    def test_io_does_not_depend_on_outer_layers(self):
        ...
        self.assert_layer_does_not_depend_on(
            "io", "file_formats", "sources", "package_managers", "references", "updaters"
        )
    ...
    def test_file_formats_do_not_depend_on_outer_layers(self):
        ...
        self.assert_layer_does_not_depend_on("file_formats", "sources", "package_managers", "references", "updaters")
    ...
    def test_sources_do_not_depend_on_outer_layers(self):
        ...
        self.assert_layer_does_not_depend_on("sources", "file_formats", "package_managers", "references", "updaters")

    def test_package_managers_do_not_depend_on_outer_layers(self):
        """Test that package_managers don't depend on their sibling references or on the updaters layer above them."""
        self.assert_layer_does_not_depend_on("package_managers", "references", "updaters")

    def test_references_do_not_depend_on_outer_layers(self):
        """Test that references don't depend on their sibling package_managers or on the updaters layer above them."""
        self.assert_layer_does_not_depend_on("references", "package_managers", "updaters")
