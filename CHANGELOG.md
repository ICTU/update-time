...
- Report each reference no registry serves at log level DEBUG, naming what accounts for it.
- Skip a Docker Compose file or CircleCI config whose YAML does not parse, with a warning, instead of ending the run.
