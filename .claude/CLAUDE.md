...
10. Check a claim against the code before stating it — "nothing covers this yet", "it can't live there" — since a sibling module or an existing test usually settles it. A review finding is a claim too, and a challenged claim is one to check again, not to repeat. So is an instruction in an issue: check what it assumes against the code before carrying it out.
