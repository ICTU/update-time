...
- **Comments**: don't add comments or docstrings that justify or narrate a change; they describe how the code behaves, not why an edit was made, and not what the code deliberately doesn't do.
