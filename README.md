...
requirements.txt, Python PEP 723 inline script metadata, package.json,
Dockerfiles, GitHub Actions workflows, CircleCI configs, GitLab CI configs,
Docker Compose and Helm manifests, devcontainer configs, and jsDelivr URLs. A
...
options:
  ...
  --cooldown DAYS       number of days to hold back newly published Docker
                        ...
                        pyproject.toml, Python inline script metadata, and
                        jsDelivr versions (default: 7)
