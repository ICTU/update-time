...
class Unserved(StrEnum):
    """Why no registry serves a reference, so Update-time leaves it as it is."""
    ...
    BUILD_STAGE = "it names a build stage the Dockerfile defines earlier"
...
class DependencyVersion:
    ...
    unserved: Unserved | None = None  # Why no registry serves the reference, when the file itself accounts for it
