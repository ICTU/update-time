...
cooldown, run the manager to bump versions, and report what changed — using the `manifests` layer to read/write
...
and the Node managers work too differently to share one (npm and pnpm do share a dataclass within their module).
"""
